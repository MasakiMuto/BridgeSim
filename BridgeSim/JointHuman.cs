...
namespace Masa.BridgeSim
{
	public class JointHuman : DrawableGameComponent
	{
			...
			: base(game)
		{
			...
			leftArm.AddChild(
				new Joint(2, new Vector2(.3f, .3f), Vector3.Zero, new ValueWithRange(MathHelper.PiOver2, -MathHelper.PiOver2, MathHelper.Pi), new ValueWithRange(MathHelper.PiOver2 * .8f, -MathHelper.Pi, MathHelper.Pi), new ValueWithRange(0, -MathHelper.PiOver2, MathHelper.PiOver2)) { Color = Color.Pink }//ひじ
				.AddChild(
			...
			leftLeg.AddChild(new Joint(2.5f, new Vector2(1f, 1), Vector3.Zero, new ValueWithRange(0, -MathHelper.PiOver2, MathHelper.PiOver2), new ValueWithRange(MathHelper.PiOver2, -MathHelper.PiOver2, MathHelper.Pi), new ValueWithRange(0, -MathHelper.PiOver4, MathHelper.PiOver4)) { Color = Color.LightBlue }//膝
				.AddChild(
					new Joint(2.5f, new Vector2(.8f, .8f), Vector3.Zero, new ValueWithRange(0), new ValueWithRange(0, 0, MathHelper.Pi), new ValueWithRange(0, -MathHelper.Pi / 8, MathHelper.Pi / 8)) { Color = Color.Blue }//足首
					.AddChild(
